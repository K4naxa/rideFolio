          ...
          <CardContent>
            <form @submit="onSubmit" class="flex flex-col gap-6 p-4 md:p-8" data-cy="login-form">
              ...
              <div class="grid grid-cols-3 gap-4">
                ...
                <Button variant="outline" type="button" class="w-full" @click="toast.success('logged in via google')">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
                ...
                <Button variant="outline" type="button" class="bg-secondary text-secondary-foreground w-full">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
