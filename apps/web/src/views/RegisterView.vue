  ...
  <main class="grid place-items-center min-h-screen p-4">
    <div class="w-full max-w-sm md:max-w-xl">
      <div class="flex flex-col gap-6">
        <Card class="overflow-hidden p-0">
          <CardContent>
            <form @submit="onSubmit" class="flex flex-col gap-6 p-4 md:p-8">
              ...
              <div>
                <Field name="name" v-slot="{ field, errorMessage }" :validate-on-blur="false">
                  <FormInput placeholder="Username" v-bind="field" />
              ...
              <div>
                <Field name="email" v-slot="{ field, errorMessage }" :validate-on-blur="false">
                  <FormInput type="email" placeholder="Email" v-bind="field" />
                  <span class="text-sm text-red-600 mt-1">{{ errorMessage }}</span>
                </Field>
              </div>
        ...
        >
          By using this service, you agree to the <a href="#">Terms of Service</a> and{" "}
