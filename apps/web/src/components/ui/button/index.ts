    ...
    " aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-destructive text-status-fg shadow-xs hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60",
        outline:
        ...
        submit: "bg-primary text-primary-foreground shadow-xs hover:bg-primary/90 w-full sm:w-auto sm:flex-1 sm:min-w-0 sm:shrink",
      },
      size: {
