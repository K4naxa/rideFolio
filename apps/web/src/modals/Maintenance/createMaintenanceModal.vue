  ...
  >
    <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-6">
      ...
      <div class="flex flex-col gap-4">
        ...
        <!-- Mobile: nested drawer for parts -->
        <Drawer v-if="isMobile" v-slot="{ onOpenChange }">
        ...
        <Textarea name="notes" class="w-full flex-1" label="Notes" placeholder="Maintenance notes" :maxlength="1000" />
      ...
      <!-- Right column: parts list (desktop only) -->
      <div v-if="!isMobile" class="flex flex-1 flex-col">
