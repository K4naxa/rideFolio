...
export const NoteSchema = z
  .object({
    ...
    title: z.string().max(100, "100 character limit passed").optional().nullable().default(null),
    content: z
      .string()
      ...
      .nullable()
      .default(null),
    tags: z.array(z.string().max(30, "30 character limit passed")).optional().default([]),
    pinned: z
      .preprocess(
